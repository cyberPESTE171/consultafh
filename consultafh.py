...
def ip():  
    ...
    if n1=='1' or n1=='01':
        ...
        br3='\n{}[+] CONSULTA REALIZADA PELO SCRIPT DE CONSULTA-FH \n[+] by: cyberPESTE{}\n{}-=[ip_address]:{}\n-=[country]:{}\n-=[country code]:{}\n-=[continent]:{}\n-=[continente codigo]:{}\n-=[cidade]:{}\n-=[condado]:{}\n-=[região]:{}\n-=[código da região]:{}\n-=[fuso horário]:{}\n-=[proprietário]:{}\n-=[longitude]:{}\n-=[latitude]:{}\n-=[moeda]:{}\n-=[língua]:{}\n{}'.format(ng,f,vd,req3['ip_address'],req3['country'],req3['country_code'],req3['continente'],req3['continent_code'],req3['cidade'],req3['county'],req3['region'],req3['region_code'],req3['timezone'],req3['owner'],req3['longitude'],req3['latitude'],req3['currency'],req3['linguages'],f)
        print(br3)
def cep():    
...
{ml}                 criado por:
       ...
       ´´´´´´´´´´´´´´¶´¶´¶´¶´¶´´´´´´´´´´´´´´´ 
               ...
               >>CONSULTAS BASICAS {f}
{ng}
>>>nosso discord:  https://discord.gg/vZ7VNb4Qw8

>>>cyberPESTE: https://www.youtube.com/channel/UC-eAYu3NNy6qbGJsVB3zevg

>>>Rebreakk 水: https://www.youtube.com/channel/UCF_kCRCETFHlsz1s9Ad85VQ {f}
{mg}By: PESTE171 {f}

>>{mg} [  {ml} CONSULTA-FH {ml} ]  {f}
    	 	       
- {ml}[{f}{ml}01{f}{ml}]{f} {ng}CONSULTAR IP {f}
- {ml}[{f}{ml}02{f}{ml}]{f} {ng}CONSULTAR CEP {f}
- {ml}[{f}{ml}03{f}{ml}]{f} {ng}CONSULTAR CNPJ {f}
- {ml}[{f}{ml}04{f}{ml}]{f} {ng}SAIR{f}
    """)
try:
    menu()
    inpu=str(input(f'- {mg}=+>{f} '))
